# Debian 9.x - Generate and encrypt passwords (makepasswd)
...
Package info: https://packages.debian.org/stretch/makepasswd
...
Source: https://manpages.debian.org/cgi-bin/man.cgi?query=makepasswd&apropos=0&sektion=0&manpath=Debian+9+stretch&format=html&locale=en
